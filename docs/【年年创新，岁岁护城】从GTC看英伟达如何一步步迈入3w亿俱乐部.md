...
![](assets/2/0/209d7cd6518fd0541a418d7414118425.jpg)
...
![](assets/5/8/58a4f098c9bec40b3e33403487d17736.png)
...
![](assets/b/c/bcc4abcf5d647f4cd06a048adcd4c0cd.png)
...
![](assets/8/2/82856d8b32e45f198ea4450bcb9bd40c.png)
...
![](assets/a/b/ab5510cc20c6e4f10d1772316afa72d6.png)
在2017年，英伟达推出了新一代的DGX-1V，基于8块V100设计。这款性能更强，性能从170 TFLOPS提升到了960 TFLOPS，后来两者都叫DGX-1。需要注意的是，他送给OpenAI的是第一代DGX-1，也就是P100版本。![](assets/2/2/22d15c8760ddc17b7e2b125f8591b053.png)
...
![](assets/4/3/434ee0cc2d3f99634fcbaca843cc5084.png)
...
![](assets/a/c/ac77ce7c3a2c4bd7e6a24906864c4848.png)

  

#### 2\. 引入Tensor核心的V100

![](assets/9/a/9a6ddeda113e3011c459f2aac0abfb3b.png)
...
![](assets/5/8/5893829f130ec50abb96a22f2575b407.png)
...
![](assets/1/3/13e72e927f7db946a107d3ac75fe57a8.png)
...
![](assets/2/1/21930f28350bea66bd3721437d812f0a.png)
...
![](assets/1/e/1ea4694af0af960f4e143189e48fa88d.png)

  

TensorRT的定位是高性能的通用模型引擎，它可以对模型进行各种优化后加载，包括无损降低精度、层和张量融合、多流执行和时间融合……再把服务接口暴露给上层推理服务器。

![](assets/f/a/fab6c7540f156c698e4cb7592eb4456c.png)
...
![](assets/5/b/5b8d508c45f6b4cd5541528ae0916490.png)

image.png

架构图如下，可以看出，它把TensorRT和其他深度学习框架的推理引擎放在了同等的位置，不需要强绑定。

![](assets/8/6/86af9a377b87718366e1b863d251b13a.png)
...
![](assets/e/6/e6dd1a90dd4c5f9935a68e76232ab1c1.png)
...
![](assets/a/9/a9f67640145937cc3bb9c7e361b4d558.png)
...
![](assets/e/2/e21ca0fe767936ab6fd77ca0bad1b45c.png)
...
![](assets/e/d/ede44dd2e6c8e41e56fb7e8141f7722d.png)

  

![](assets/8/d/8dad5e56d0962af00d91025d16554374.png)
...
![](assets/f/4/f42a85682a1bffbda4f756beaa77ba28.png)
...
![](assets/d/2/d25f3488631a52e6c48d98ce84505954.png)

  

而借助MIG的隔离技术，A100可以在物理层面上1虚7，每个的推理性能，都相当于一个V100，对云服务非常友好。在接下来的几年，英伟达都没有推过T4的继任。（直到2023的L40和L4）

![](assets/8/c/8c597465af991461fb9d9ba3daafe91d.png)
...
![](assets/c/1/c13e4ef586b226adbaba3bb8e701f9d0.png)
...
![](assets/7/b/7b8dff096b4f97b335b57f354555ace7.png)
...
![](assets/1/6/161a40bbe1b15c719f17d07144c2e185.png)
...
![](assets/9/1/915aaf84011229b63abc515da00384ca.png)
...
![](assets/e/8/e87ed219a3e21cc661b659650dc9d8c8.png)
...
![](assets/e/5/e524e30670b5f0f88da55f2af72ac427.png)

  

![](assets/0/6/06cdbd8e57d1f5e1250a3293c8fadf65.png)
...
![](assets/1/1/11e708427f512fc16609e127397db33a.png)
...
![](assets/b/e/bed2796e92cd26beef9ce07b64201230.png)
...
![](assets/0/2/02f5234e33f35cba96d7334128b5be75.png)
...
### ![](assets/8/2/82f4a62dd5f046cca3dd399d7d0d1ef6.png)

《奇异博士2：疯狂多元宇宙》就是2022年上映的，这里明显也做了一点致敬。![](assets/b/3/b37e9c7c26247e81772333802a7fa569.png)
...
![](assets/7/b/7bdf94b7097e493602627de7a530d6dc.png)
...
![](assets/1/a/1a061de0c5de691f4151608746af5426.png)
...
![](assets/a/1/a146d7896af6f04a4f6163bc653a11c7.png)
...
![](assets/e/a/eae00f6a2458248a01f1c53ba0b124f5.jpg)
1\. B200和GB200这次的主角之一是B200芯片和GB200，性能毫无悬念地强劲。当然还有NVL72，将液冷技术应用带到一个新台阶。![](assets/c/9/c98f0ffdfe7c6a0e51d39c0b5c03d0e2.png)

  

GB200将Grace-n的优势提升到一个新台阶，1拖2达到了惊人的40 PFLOPS。也许下一款X100发布，GX200就是1拖4的设计了，届时性能又是一个全新的境界。

![](assets/e/9/e934a64cca6791f8b2e6504837988091.png)
...
![](assets/1/1/11db778ca486186bcda21107e9c7b631.png)
...
![](assets/0/1/01dc117433fa46b178b373feae0b6e8c.png)
...
![](assets/7/5/75e06360649a807b2db274bc31ce6f4d.png)

这张8年芯片算力进化图，某种程度上和英伟达的市值不谋而合，如出一辙地冲上天际。1000倍的算力，150倍的股价。这是时代的馈赠，也是给勇者的礼物。

![](assets/0/3/03e8ce00581eebacbcc9b0dd7e312b5d.png)
...
![](assets/e/e/ee156643d05c6dc46148fbda2354ceed.jpg)